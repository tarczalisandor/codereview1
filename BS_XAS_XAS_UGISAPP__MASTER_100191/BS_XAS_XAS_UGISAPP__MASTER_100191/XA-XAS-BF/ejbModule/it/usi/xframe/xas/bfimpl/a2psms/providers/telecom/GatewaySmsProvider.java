	...
	// *** MULTIPART DEFINITION ***
 	...
 	public InternalSmsResponse sendMessage(InternalSmsResponse internalSmsResponse, InternalSmsRequest internalSmsRequest, XasUser xasUser, Provider provider, Originator originator, boolean multipart, Chronometer chronometer) throws XASException {
        ...
        try {
			...
			if(service == null) 
				throw new XASException(ConstantsSms.XAS04098E_MESSAGE, null, ConstantsSms.XAS04098E_CODE, new Object[] {"Failed to instantiate SMS TelecomPop proxy for " + Configuration.JNDI_POP_SOAP_URL});
...
//			bindingProvider.setPassword(customization.getDecodedPassword());
		...
		if (!multipart) {
        	...
        	mtSendingResult = sendTelecom(myUUID, service, mtMessage, chronometer, 1);
    		if (Result.KO.equals(mtSendingResult.getResult())) {
    			// Failure
    			internalSmsResponse.setCode(ConstantsSms.XAS04098E_CODE);
    			internalSmsResponse.setMessage(MessageFormat.format(ConstantsSms.XAS04098E_MESSAGE, new Object[] {mtSendingResult.getReason().getValue(), mtSendingResult.getReason()}));
    			errorExit = true;
    		}
...
//	    		System.out.println("maxBytesPerPart=" + maxBytesPerPart + ", nByte=" + nByte + ", encodedBytes.length=" + encodedBytes.length + ", byteCount=" + byteCount);
	        	...
	        	mtSendingResult = sendTelecom(myUUID, service, mtMessage, chronometer, partNumb);
 	 ...
 	 * @throws XASException
 	 */
	private MtSendingResult sendTelecom(String myUUID, SmsSendingServicePortType service, MtMessage mtMessage, Chronometer chronometer, int index) throws XASException {
		MtSendingResult mtSendingResult;
        try {
        	...
        	if (cause != null && cause.indexOf("java.net.SocketTimeoutException") > -1)
        		throw new XASException(ConstantsSms.XAS03094E_MESSAGE, errors.toString(), ConstantsSms.XAS03094E_CODE, new Object[] {Configuration.JNDI_POP_SOAP_URL, cause});
        	else
        		throw new XASException(ConstantsSms.XAS04098E_MESSAGE, errors.toString(), ConstantsSms.XAS04098E_CODE, new Object[] {"RemoteException for " + Configuration.JNDI_POP_SOAP_URL, cause});
        } 
        
		if(mtSendingResult == null)
			throw new XASException(ConstantsSms.XAS04098E_MESSAGE, null, ConstantsSms.XAS04098E_CODE, new Object[] {"Null response object returned by Telecom service"});
   ...
   public static URL getTelecomPopURL() throws XASException {
        ...
        try {
    		...
    		throw new XASException(ConstantsSms.XAS03095E_MESSAGE, errors.toString(), ConstantsSms.XAS03095E_CODE, new Object[] {"NameNotFoundException", Configuration.JNDI_POP_SOAP_URL, "Check jndiName presence in /XA-XAS/META-INF/ibmconfig/cells/defaultCell/applications/defaultApp/deployments/defaultApp/resources.xml", errors.toString()});
        } catch (NamingException e) {
        	StringWriter errors = new StringWriter();
        	e.printStackTrace(new PrintWriter(errors));
        	logger.error(errors.toString());
    		throw new XASException(ConstantsSms.XAS03095E_MESSAGE, errors.toString(), ConstantsSms.XAS03095E_CODE, new Object[] {"NamingException", Configuration.JNDI_POP_SOAP_URL, "none", errors.toString()});
        }
