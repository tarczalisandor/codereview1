/**
 * XasNotificationSoapBindingStub.java
 *
...
public class XasNotificationSoapBindingStub extends com.ibm.ws.webservices.engine.client.Stub implements it.usi.xframe.xas.wsutil.XasNotification {
    public XasNotificationSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws com.ibm.ws.webservices.engine.WebServicesFault {
        if (service == null) {
    ...
    private void initTypeMapping() {
        ...
        xmlType = com.ibm.ws.webservices.engine.utils.QNameTable.createQName("http://data.bfutil.xas.xframe.usi.it", "NotificationResponse");
        sf = com.ibm.ws.webservices.engine.encoding.ser.BaseSerializerFactory.createFactory(com.ibm.ws.webservices.engine.encoding.ser.BeanSerializerFactory.class, javaType, xmlType);
        df = com.ibm.ws.webservices.engine.encoding.ser.BaseDeserializerFactory.createFactory(com.ibm.ws.webservices.engine.encoding.ser.BeanDeserializerFactory.class, javaType, xmlType);
        if (sf != null || df != null) {
            tm.register(javaType, xmlType, sf, df);
    ...
    private com.ibm.ws.webservices.engine.description.OperationDesc _getnotifyMobileOriginatedOperation0() {
        ...
        com.ibm.ws.webservices.engine.description.ParameterDesc[]  _params0 = new com.ibm.ws.webservices.engine.description.ParameterDesc[] {
         new com.ibm.ws.webservices.engine.description.ParameterDesc(com.ibm.ws.webservices.engine.utils.QNameTable.createQName("http://wsutil.xas.xframe.usi.it", "mobileOriginated"), com.ibm.ws.webservices.engine.description.ParameterDesc.IN, com.ibm.ws.webservices.engine.utils.QNameTable.createQName("http://wsutil.xas.xframe.usi.it", "MobileOriginated"), it.usi.xframe.xas.wsutil.MobileOriginated.class, false, false, false, true),
          };
        ...
        _notifyMobileOriginatedOperation0 = new com.ibm.ws.webservices.engine.description.OperationDesc("notifyMobileOriginated", _params0, com.ibm.ws.webservices.engine.utils.QNameTable.createQName("http://wsutil.xas.xframe.usi.it", "notifyMobileOriginatedReturn"));
        _notifyMobileOriginatedOperation0.setReturnType(com.ibm.ws.webservices.engine.utils.QNameTable.createQName("http://data.bfutil.xas.xframe.usi.it", "NotificationResponse"));
        ...
        _notifyMobileOriginatedOperation0.setSoapAction("notifyMobileOriginated");
    ...
    private synchronized com.ibm.ws.webservices.engine.client.Stub.Invoke _getnotifyMobileOriginatedInvoke0(Object[] parameters) throws com.ibm.ws.webservices.engine.WebServicesFault  {
        ...
        if (mc == null) {
            ...
            mc.setSOAPActionURI("notifyMobileOriginated");
    ...
    public it.usi.xframe.xas.wsutil.NotificationResponse notifyMobileOriginated(it.usi.xframe.xas.wsutil.MobileOriginated mobileOriginated) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
            throw new com.ibm.ws.webservices.engine.NoEndPointException();
        }
        java.util.Vector _resp = null;
        try {
            _resp = _getnotifyMobileOriginatedInvoke0(new java.lang.Object[] {mobileOriginated}).invoke();
    ...
    private com.ibm.ws.webservices.engine.description.OperationDesc _getnotifyDeliveryReportOperation1() {
        ...
        com.ibm.ws.webservices.engine.description.ParameterDesc[]  _params1 = new com.ibm.ws.webservices.engine.description.ParameterDesc[] {
         new com.ibm.ws.webservices.engine.description.ParameterDesc(com.ibm.ws.webservices.engine.utils.QNameTable.createQName("http://wsutil.xas.xframe.usi.it", "deliveryReport"), com.ibm.ws.webservices.engine.description.ParameterDesc.IN, com.ibm.ws.webservices.engine.utils.QNameTable.createQName("http://wsutil.xas.xframe.usi.it", "DeliveryReport"), it.usi.xframe.xas.wsutil.DeliveryReport.class, false, false, false, true),
          };
        ...
        _notifyDeliveryReportOperation1 = new com.ibm.ws.webservices.engine.description.OperationDesc("notifyDeliveryReport", _params1, com.ibm.ws.webservices.engine.utils.QNameTable.createQName("http://wsutil.xas.xframe.usi.it", "notifyDeliveryReportReturn"));
        _notifyDeliveryReportOperation1.setReturnType(com.ibm.ws.webservices.engine.utils.QNameTable.createQName("http://data.bfutil.xas.xframe.usi.it", "NotificationResponse"));
        ...
        _notifyDeliveryReportOperation1.setSoapAction("notifyDeliveryReport");
    ...
    private synchronized com.ibm.ws.webservices.engine.client.Stub.Invoke _getnotifyDeliveryReportInvoke1(Object[] parameters) throws com.ibm.ws.webservices.engine.WebServicesFault  {
        ...
        if (mc == null) {
            ...
            mc.setUseSOAPAction(true);
            mc.setSOAPActionURI("notifyDeliveryReport");
            mc.setOperationStyle("wrapped");
            mc.setOperationUse("literal");
            mc.setEncodingStyle(com.ibm.ws.webservices.engine.Constants.URI_LITERAL_ENC);
            mc.setProperty(com.ibm.ws.webservices.engine.client.Call.SEND_TYPE_ATTR, Boolean.FALSE);
    ...
    public it.usi.xframe.xas.wsutil.NotificationResponse notifyDeliveryReport(it.usi.xframe.xas.wsutil.DeliveryReport deliveryReport) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
            throw new com.ibm.ws.webservices.engine.NoEndPointException();
        }
        java.util.Vector _resp = null;
        try {
            _resp = _getnotifyDeliveryReportInvoke1(new java.lang.Object[] {deliveryReport}).invoke();
