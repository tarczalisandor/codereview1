...
public class InternalSmsRequest {
	...
	public void validateDelivery(DateTime validity) throws XASWrongRequestException {
		...
		if (myDelivery.isAfter(limit)) 
			throw new XASWrongRequestException(ConstantsSms.XAS01005E_MESSAGE, null, ConstantsSms.XAS01005E_CODE, new Object[] {ConstantsSms.ISO_DATE_FORMAT.format(getDeliveryTime())});
		if (validity != null && myDelivery.isAfter(validity)) 
			throw new XASWrongRequestException(ConstantsSms.XAS01006E_MESSAGE, null, ConstantsSms.XAS01006E_CODE, new Object[] {ConstantsSms.ISO_DATE_FORMAT.format(getDeliveryTime()), ConstantsSms.ISO_DATE_FORMAT.format(validity.toDate())});
		return;
	}
	...
	public DateTime validateValidity(Integer defaultValidityPeriod) throws XASWrongRequestException {
		...
		if (validity.isBeforeNow()) 
			throw new XASWrongRequestException(ConstantsSms.XAS01007E_MESSAGE, null, ConstantsSms.XAS01007E_CODE, new Object[] {ConstantsSms.ISO_DATE_FORMAT.format(validity.toDate())});
 
		DateTime limit = new DateTime().plus(VALIDITY_LIMIT);
		if (validity.isAfter(limit)) 
			throw new XASWrongRequestException(ConstantsSms.XAS01008E_MESSAGE, null, ConstantsSms.XAS01008E_CODE, new Object[] {ConstantsSms.ISO_DATE_FORMAT.format(validity.toDate()), VALIDITY_LIMIT});
