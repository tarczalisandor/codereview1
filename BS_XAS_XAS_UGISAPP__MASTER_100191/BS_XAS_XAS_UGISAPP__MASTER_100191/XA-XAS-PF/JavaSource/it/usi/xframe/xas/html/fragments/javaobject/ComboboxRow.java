...
public class ComboboxRow extends HtmlObject
{
	private static final String COMPONENT_NAME = "comboboxrow_";
	 ...
	 * @param selected
	 */
	public ComboboxRow(String name, String text, boolean selected)
	{
		super();
		this.setName(name);
		this.text = text;
