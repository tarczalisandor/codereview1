	...
	public void sendSms(SmsMessage	sms, SmsSenderInfo sender) throws ServiceFactoryException, RemoteException, XASException{
		...
		try{ // 
			if (log.isDebugEnabled()) {
				SmartLog sl = new SmartLog().logItCompact(ConstantsSms.MY_APPL_ID, ConstantsSms.MY_LOG_VER, SendSms.class.getName(), ConstantsSms.MY_UUID_INIT, SmartLog.V_SCOPE_DEBUG); 
