...
public class PgeTokenSendSms2 {
	...
	public SmsResponse sendSms2(SmsRequest	smsRequest) throws ServiceFactoryException, RemoteException, XASException{
		SmartLog sl = new SmartLog().logItCompact(ConstantsSms.MY_APPL_ID, ConstantsSms.MY_LOG_VER, "SendSms2", (String) MDC.get(eu.unicredit.xframe.slf.Constants.MDC_KEY_UUID), SmartLog.V_SCOPE_DEBUG); 
