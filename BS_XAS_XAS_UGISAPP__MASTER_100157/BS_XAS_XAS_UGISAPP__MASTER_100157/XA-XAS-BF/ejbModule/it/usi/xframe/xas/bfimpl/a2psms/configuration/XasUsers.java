...
public class XasUsers extends HashMap {
	...
	public synchronized XasUser getFinalXasUser(String myUUID, String xasUserName, String defaultXasUserName) throws XASException {
		SmartLog sl = new SmartLog(SmartLog.COUPLING_LOOSE_I).logItCompact(Constants.MY_APPL_ID, Constants.MY_LOG_VER, XasUsers.class.getName(), myUUID, SmartLog.V_SCOPE_DEBUG)
		...
		if (xasUser == null) 
			throw new XASException(Constants.XAS00012E_MESSAGE, null, Constants.XAS00012E_CODE, new Object[] {xasUserName, defaultXasUserName});
		...
		try {
			...
			SmartLog slException = new SmartLog(SmartLog.COUPLING_LOOSE_I)
        		.logItCompact(Constants.MY_APPL_ID, Constants.MY_LOG_VER, XasUsers.class.getName(), myUUID, SmartLog.V_SCOPE_DEBUG)
