...
public class Provider implements Cloneable {
	...
	public Originator getFinalOriginator(String myUUID, String phoneNumber, XasUser xasUser) throws XASException {
		SmartLog sl = new SmartLog(SmartLog.COUPLING_LOOSE_I).logItCompact(Constants.MY_APPL_ID, Constants.MY_LOG_VER, Provider.class.getName(), myUUID, SmartLog.V_SCOPE_DEBUG)
			...
			while (iterator.hasNext()) {
			  ...
			  if (value.getRouterRegex() != null && value.getRouterRegex().matcher(phoneNumber).matches())
				  if (originator == null) 
					  ...
					  throw new XASException(Constants.XAS00015E_MESSAGE, null, Constants.XAS00015E_CODE, new Object[] {phoneNumber, originator.getName(), key});
		...
		if (originator == null)	
			throw new XASException(Constants.XAS00016E_MESSAGE, null, Constants.XAS00016E_CODE, new Object[] {xasUser.getOriginator()});
