...
public class CustomizationBasic extends CustomizationAbstract {
	...
	static public String decryptPassword(String password) throws XASException {
		...
		try {
        	...
        	throw new XASException(Constants.XAS00098E_MESSAGE, null, Constants.XAS00098E_CODE, new Object[] {"Error Encoding Password - Unsupported", ""});
        } catch (SLF_Exception e) {
        	throw new XASException(Constants.XAS00098E_MESSAGE, null, Constants.XAS00098E_CODE, new Object[] {"Error Encoding Password - SLF_Exception", ""});
        }
