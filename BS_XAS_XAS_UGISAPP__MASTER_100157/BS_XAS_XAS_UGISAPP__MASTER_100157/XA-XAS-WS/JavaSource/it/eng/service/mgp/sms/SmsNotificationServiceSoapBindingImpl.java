...
//			NewDeliveryStatusResponse newDeliveryStatusResponse = null;
        ...
        try {
			...
			SmartLog sl = new SmartLog().logItCompact(Constants.MY_APPL_ID, Constants.MY_LOG_VER, "SmsNotification", myUUID, SmartLog.V_SCOPE_DEBUG)
        ...
        try{ // UUID retrieved from SOAP Header
			...
			if (! (Constants.XAS00000I_CODE.equals(deliveryResponse.getCode()) 
			    || Constants.XAS00080I_CODE.equals(deliveryResponse.getCode())
			    || Constants.XAS00082E_CODE.equals(deliveryResponse.getCode())
			    )) { 
...
//			NewDeliveryStatusResponse newDeliveryStatusResponse = null;
        ...
        try {
			...
			SmartLog sl = new SmartLog().logItCompact(Constants.MY_APPL_ID, Constants.MY_LOG_VER, "SmsNotification", myUUID, SmartLog.V_SCOPE_DEBUG)
										.logIt(SmartLog.K_METHOD, "newMessage", SmartLog.K_PHASE, SmartLog.V_PHASE_ENTER, Constants.K_UUID_TYPE, myUUID).preset("default"); 
